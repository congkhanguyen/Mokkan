...
namespace MokkAnnotator.MkaImageProcess
{
    ...
    public static class SystemTools
    {
        ...
        public static unsafe void SetToZero(void* dst, ulong length)
        {
            memset(dst, 0, new UIntPtr(length));
        }
        ...
        private static extern unsafe void memset(void* dst, int c, UIntPtr length);
#endif
    }
}
