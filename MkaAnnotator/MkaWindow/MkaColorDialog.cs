...
namespace MokkAnnotator.MkaWindow
{
    ...
    /// Color Select Dialog
    /// </summary>
    public class MkaColorDialog : Form
    {
        byte max = 40;
        ...
        string[] colorName = new string[40]
    {
        ...
        public MkaColorDialog(int x, int y)
        {
            ...
            moreColorsButton.Text = "その他の色(&M)";
            moreColorsButton.Size = new Size(145, 22);
            moreColorsButton.Location = new Point(5, 115);
            ...
            cancelButton.Size = new Size(16, 16);
            cancelButton.Location = new Point(135, 0);
            cancelButton.BackgroundImage = global::MokkAnnotator.Properties.Resources.dialogclose;
